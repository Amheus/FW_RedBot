...
class Moderation(commands.Cog):
    ...
    async def report(self, context):
        ...
        log_event(level=DEBUG, details="'$report' command called")
    ...
    async def ilence(self, context):
        ...
        log_event(level=DEBUG, details="'$ilence' command called")
        ...
        if muteRole == None:
            log_event(level=ERROR, details="ERROR: Mute role not found, check ID is correct")
        else:
