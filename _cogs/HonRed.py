...
class HonRed(commands.Cog):
    ...
    async def honstatus(self, context):
        log_event(level=DEBUG, details="'$honstatus' command called")
        ...
        if not found:
            ...
            log_event(level=ERROR, details="Command failed, couldnt find user")
        ...
        if found:
            ...
            log_event(level=DEBUG, details="Collected Cell Values")
    ...
    async def honupdate(self, context):
        ...
        if msg.channel.name == "honorary-red-logging":
            log_event(details="'$honupdate' command called")
    ...
    async def honregister(self, context):
        ...
        log_event(level=DEBUG, details="'$honregister' command called")
